...
def branch_1_decision1():
    ...
    print("")
    gen_character.set_health(gen_character.get_health() - 10)
    ...
    who_died_battle1 = battle(floor=1, enemygen=ben, generate_character=gen_character)
    ...
    if who_died_battle1 == True:
        ...
        typing(
            f"{gen_character.get_name()}: Ben, listen, you were acting strange, you were the first one to\n"
            f"hit me, my nose is bleeding as well...")
        typing(
            f"Ben: You know I work for the guards, you can keep rumbling all you want, you fucker, I will take\n"
            f"you where you belong")
...
def branch_1_decision2():
    ...
    if who_died_battle1 == True:
        time.sleep(5)
        typing("You're hitting Ben, really hard, you see that he's crying, his face is red, you stop")
        typing(f"{gen_character.get_name()}: You're saying nonsense Ben, you know I don't tolerate like that shit")
...
def branch_1_decision3():
    ...
    if who_died_battle1  == True:
        ...
        typing("You're hitting Ben, really hard, you see that he's crying, his face is red, you stop")
        typing("Ben: Why did you do that, you fucking maniac, I always knew you were crazy, you piece of shit")
        typing(f"{gen_character.get_name()}: Ben, listen, you were acting strange, you were the first one to\n"
               f"hit me, my nose is bleeding as well...")
...
def branch_2():
    typing("You sleep a little bit more, however, some noices on the door wakes you up")
    typing("You are fucking pissed, you wake up, you see that someone is knocking on your door")
    typing("You go and check to see who's knocking")
    time.sleep(3)
    typing(f"Ben: Hey {gen_character.get_name()}, I just wanted to check if you're okay, I heard noises, are you okay?")
    ...
    if decision_1 == 1:
        ...
        typing(f"{gen_character.get_name()}: (Thinking) Sure, fuck off")
        ...
        typing(f"{gen_character.get_name()}: Sure, I think I have it, come in")
        ...
        typing(f"{gen_character.get_name()}: What do you mean for a single person? Lol")
        time.sleep(2)
        typing("Ben: Yes, all of this world is for a single person to grow and mature, that we're all one and the same")
        typing(f"{gen_character.get_name()}: I don't follow, but its fine dude, look, I found the honey")
        time.sleep(2)
        typing(
        ...
        typing(
            f"{gen_character.get_name()}: Oh, yeah that way we can all grow and mature, I mean living a lot of lives would make you wiser, don't you think Ben?")
        time.sleep(4)
        typing(
            f"Ben: No, {gen_character.get_name()} is only you, there's no one else... is only for you to grow and mature...")
        typing(f"{gen_character.get_name()}: That's pretty deep Ben, you should stop going to that tavern dude, Lol")
        time.sleep(3)
        typing(f"Ben: You know I like to drink... seeing too many people dying lately just makes me want to drink more")
        typing(f"{gen_character.get_name()}: Yeah, I heard... that disease is killing everyone, isn't it?")
        time.sleep(3)
        ...
        time.sleep(3)
        typing(f"{gen_character.get_name()}: Did you hear that?")
        print("\n")
        print("PREPARE...")
        typing(
            f"Ben: Everything was fine... One of the children that died because of the disease, she was friend of my son")
        time.sleep(3)
        typing(f"{gen_character.get_name()}: Ben, are you not listening?")
        typing(
        ...
        while decision_2 != 1 and decision_2 != 2:
            typing(
                f"{decision_2} is not either '1' or '2'... is it that hard to type '1' or '2' {gen_character.get_name()}?")
            decision_2 = int(
                input(typing("You start to panic, something seems odd(1)/ You continue listening to Ben(2): ")))
        if decision_2 == 1:
            branch_1_decision3()
...
def branch_1():
    ...
    if decision_1 == 1:
        ...
        typing(f"{gen_character.get_name()}: Oh, yeah that way we can all grow and mature, I mean living a lot of lives would make you wiser, don't you think Ben?")
        time.sleep(4)
        typing(f"Ben: No, {gen_character.get_name()} is only you, there's no one else... is only for you to grow and mature...")
        typing(f"{gen_character.get_name()}: That's pretty deep Ben, you should stop going to that tavern dude, Lol")
        time.sleep(3)
        typing(f"Ben: You know I like to drink... seeing too many people dying lately just makes me want to drink more")
        typing(f"{gen_character.get_name()}: Yeah, I heard... that disease is killing everyone, isn't it?")
        ...
        while decision_2 != 1 and decision_2 != 2:
            typing(f"{decision_2} is not either '1' or '2'... is it that hard to type '1' or '2' {gen_character.get_name()}?")
            decision_2 = int(input(typing("You start to panic, something seems odd(1)/ You continue listening to Ben(2): ")))
        if decision_2 == 1:
            branch_1_decision3()
        ...
        typing(f"{gen_character.get_name()}: Nah I just feel dizzy man, want to come in and grab a bite?")
        time.sleep(3)
        typing("Ben: Sure, I'm starving")
        typing("As you let him enter, Ben is a talker, he starts immediately rumbling about some nonsense")
        time.sleep(2)
        typing("Ben: You know, the other day in the tavern, I heard a guy talking that all of this world was created "
               "for a single person")
        typing(f"{gen_character.get_name()}: What do you mean for a single person? Lol")
        time.sleep(2)
        typing("Ben: Yes, all of this world is for a single person to grow and mature, that we're all one and the same")
        typing(f"{gen_character.get_name()}: I don't follow, but its fine dude, what'd you like to eat?")
        time.sleep(2)
        typing(f"Ben: It's quite perturbing actually, for example, let's say for instance, that you die right now, \n"
               f"this guy was saying that after you die, you encounter this random dude that makes you live countless "
               f"lives,\nAnd the only reason is for you to grow and mature")
        typing(f"{gen_character.get_name()}: Oh, yeah that way we can all grow and mature, I mean living a lot of lives "
               f"would make you wiser, don't you think Ben?")
        time.sleep(4)
        typing(f"Ben: No, {gen_character.get_name()} is only you, there's no one else... is only for you to grow and "
               f"mature...")
        typing(f"{gen_character.get_name()}: That's pretty deep Ben, you should stop going to that tavern dude, Lol")
        time.sleep(3)
        typing(f"Ben: You know I like to drink... seeing too many people dying lately just makes me want to drink more")
        ...
        print("\n")
        print("PREPARE...")
        typing(f"Ben: Everything was fine... One of the children that died because of the disease, she was friend of my"
               f" son")
        time.sleep(3)
        typing(f"{gen_character.get_name()}: Ben, are you not listening?")
        typing(f"Ben: My son cried for weeks scared that the disease would kill him as well, dude, even I am scared,\n"
               f"my wife told me to calm him down, but dude, I'm fucking scared as well")
        decision_2 = int(input(typing("You shake Ben, because he's acting odd(1) / You continue listening to Ben(2): ")))
        while decision_2 != 1 and decision_2 != 2:
            typing(
                f"{decision_2} is not either '1' or '2'... is it that hard to type '1' or '2' {gen_character.get_name()}?")
            decision_2 = int(input(typing("You shake Ben, because he's acting odd(1) / You continue listening to "
                                          "Ben(2): ")))
...
def chapter1():
    ...
    typing(f"{gen_character.get_name()}, this is just the beginning, but remember, it's just you")
    time.sleep(3)
    clear_screen()
    ...
    while decision_1 != 1 and decision_1 != 2:
        typing(f"{decision_1} is not either '1' or '2'... is it that hard to type '1' or '2' {gen_character.get_name()}"
               f"?")
